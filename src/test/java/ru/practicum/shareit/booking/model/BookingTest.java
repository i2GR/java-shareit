...
class BookingTest {
    ...
    private final User booker = User.builder().name("booker").email("booker@host.dom").build();
    private final Item item = Item.builder().id(1L).ownerId(1L).name("item").description("description").available(true).build();
